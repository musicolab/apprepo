		...
		<div class="row">
			...
			<div class="col-sm-9">
				...
				<hr style='background-color:#ddd'>
					...
					<small>
					* examples come form the public domain <!--, eg: <a href='https://www.freemusicpublicdomain.com/'>Images - Lost European</a--><br>
					</small>
					<br>
					<script>
						...
						wavesurfer.load('https://musicolab.hmu.gr/apprepository/downloadPrivateFile.php?f=<? echo $_GET["f"];?>&u=<?echo $_SESSION["USER"]['id'];?>');
						console.log('/var/www/moodledata/repository/jsonFiles/user/<? echo $_SESSION["USER"]['id'] ."/".$_GET["f"]; ?>');
					...
					<?
					error_log("-----------------------------------------");
					error_log("----- play private file (wav, mp3) ");	
					...
					$jsonExists = false;
					error_log("play private file");
					error_log("res filename = ".$res['filename']);
                                	$filename =  substr($res['filename'],48+strlen($_SESSION["USER"]['id']));
					error_log("res filename = ".$filename);
					$jsonFile = '/var/www/moodledata/repository/jsonFiles/users/'.$_SESSION["USER"]['id'].'/'.substr($filename,0,strlen($filename)-4).'.json';
				 ...
				 <div class='row'>
					<div class='col-sm-12'>
						...
						<hr style='background-color:#ddd'>
                                        ...
                                        <div class='row'>
                                                <div class='col-sm-6'>
                                                                <span style='display:inline-block;width:25%'>path:</span>       <b><?echo $filename?></b><br>
                                                ...
                                                <div class='col-sm-6'>
                                                                <span style='display:inline-block;width:25%'>duration:</span>   <b><?echo gmdate("H:i:s",(int)$res['duration'])?></b><br>
