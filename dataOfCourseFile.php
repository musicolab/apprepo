	...
	<div class="container">
		...
		<div class="row">
			...
			<?
				...
				$f    = $_GET['fid'];
                                $sql  = "select * from metadata where filetype='course' and id=".$f;
			...
			<div class="col-sm-9">
				<div class="panel panel-default" style='border:1px solid #ddd;'>
                                ...
                                ?>
				<h3><?echo $_GET['cname']?> / Metadata / <?echo $_GET['fname']?></h3>
				<hr style='background-color:#ddd'>
				<form action='dataOfCourseFile.php' method='get' id='theform'>
					<div class='row'>
						<div class='col-sm-6'>
							<fieldset>
								<label>file information</label><br>
                                                                path:       <?echo $_GET['fname']?><br>
