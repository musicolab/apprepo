<? session_start(); ?>
<?
error_log("download public file");
error_log("--------------------");
error_log("is user set? : ",isset($_GET["user"]));
$loginResultMsg = "";
$roles          = "";
                                        if(isset($_GET["user"])){
...
if(isset($_SESSION["USER"]['username'])){
	if(isset($_GET['f'])) {
		$filename = "/var/www/moodledata/repository/jsonFiles/public/".urldecode($_GET['f']);
	...
	echo "your session has expired, filename is not defined, invalid access rights";
}
?>
