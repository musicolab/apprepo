...
<body>
    ...
    if (!isset($action))
    {
        ...
        echo("invalid action, please contact the admins", 0);
    }
    else
    {
        if ($_POST['action'] == "chordBeatAnalysis")
        {
            ...
            $pyExecPath = "/home/kalohr/virtualEnvs/chordBeatAnalysis/bin/python3 ";
            $pyScriptPath ="/home/kalohr/virtualEnvs/chordBeatAnalysis/chordBeatAnalysis.py ";
