<? session_start(); ?>
<?
error_log("download course file");
error_log("--------------------");
$loginResultMsg = "";
$roles          = "";
                                        if(isset($_GET["user"])){
...
if(isset($_SESSION["USER"]['username'])){
	if(isset($_GET['f']) && isset($_GET['u'])) {
		error_log("--- DOWNLOADING COURSE FILE");
		$filename = '/var/www/moodledata/repository/jsonFiles/courses/'.$_GET['courseid'].'/'.urldecode($_GET['f']);
